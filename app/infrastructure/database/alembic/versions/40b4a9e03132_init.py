...
def upgrade() -> None:
    ...
    op.add_column(
        "appointment", sa.Column("branch_id", sa.BigInteger(), nullable=False)
    )
    op.add_column(
        "appointment", sa.Column("employee_id", sa.BigInteger(), nullable=False)
    )
    op.create_foreign_key(
        None, "appointment", "employee", ["employee_id"], ["id"], ondelete="CASCADE"
    )
    op.create_foreign_key(
        None, "appointment", "branch", ["branch_id"], ["id"], ondelete="CASCADE"
    )
